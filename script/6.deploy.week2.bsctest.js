...
async function main() {
    ...
    if (network.name == 'bsctest') {
        ...
        // add & addStore
        {
            ...
            await v1.connect(admin).addAndStore(1, 3);
            let addResult = await v1.addResult();
            console.log(' 1 + 3 = ', addResult.toNumber());
        }
        // upgrade
        {
            await upgrades.upgradeProxy(v1.address, LogicV2, {admin});
        ...
        // add & addStore sub & subStore
        {
            ...
            await v2.connect(admin).subAndStore(10, 3);
